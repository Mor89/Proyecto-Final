...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" id="frmProducto" name="frmProducto" action="<%= request.getContextPath()%>/productos" method="post">
            ...
            <label for="txtId_producto" class="col-sm-2 control-label">ID_Producto:</label>
            <div class="col-sm-10">
                    <input type="text" class="form-control" name="txtId_producto" value="<%= producto.getNom_producto()%>">
            </div>
